...
public class OrderBlockController {
    ...
    public void setInfo(Order order) {
        ...
        } catch (SQLException | NoCarByIdException | NoEmployeeByLoginException exception) {
    ...
    public void onInfoButtonClick() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(CarServiceApplication.class.getResource("client/orders/order-info-view.fxml"));
